      ...
      <div className="relative z-10 max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm mb-6"
          >
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            {t(ui.available, locale)}
          </motion.div>

          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6 text-zinc-900">
          ...
          <p className="text-xl md:text-2xl text-zinc-500 mb-2 font-medium">
          ...
          <div className="flex flex-wrap gap-4">
            <Button
              ...
              color="primary"
              size="lg"
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-full shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all"
            >
            ...
            <Button
              ...
              variant="bordered"
              size="lg"
              className="border-zinc-300 text-zinc-700 hover:bg-zinc-100 rounded-full"
            >
          ...
          <div className="flex gap-4 mt-8">
            {Object.entries(personalInfo.social).map(([platform, url]) => (
              <a
                ...
                className="w-10 h-10 rounded-full bg-white border border-zinc-200 flex items-center justify-center text-zinc-400 hover:text-indigo-600 hover:border-indigo-300 hover:shadow-md transition-all"
                aria-label={platform}
              >
